...
import { Activity, BarChart2, Settings, Home, Info, User as UserIcon, LogOut, Hexagon } from 'lucide-react';
        ...
        <div className="flex items-center gap-4 group cursor-pointer" onClick={() => setView(ViewState.HOME)}>
            ...
            <div className="hidden md:block">
                ...
                <div className="flex flex-col mt-1.5">
                    ...
                    <p className="text-[10px] text-gray-400 font-bold uppercase leading-tight max-w-[180px]">Aim High.<br/>Rise Sky-High.</p>
                </div>
            </div>
        </div>
      </div>
            ...
            return (
                <button
                    ...
                    className={`w-full flex items-center gap-4 px-3 md:px-4 py-3.5 rounded-xl transition-all group relative ${
                        isActive 
                        ? 'bg-primary text-black font-bold shadow-[0_0_20px_rgba(6,182,212,0.4)]' 
