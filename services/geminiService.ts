...
export const getChatResponse = async (history: { role: string; content: string }[], message: string) => {
    try {
        ...
        const chat = ai.chats.create({
            model: "gemini-3-flash-preview", // Updated to valid text model
            config: { 
                systemInstruction: "You are ApexMotion Support, a helpful and energetic AI assistant for a sports biomechanics app. Keep answers short, encouraging, and helpful.",
                maxOutputTokens: 250 
            },
