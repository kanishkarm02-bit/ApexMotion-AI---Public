...
import { Trophy, Activity, Dumbbell, Zap, Target, Move, ArrowRight, PlayCircle, Disc, Flag, Heart, Crosshair, Hexagon, ShieldCheck, Cpu, Layers, Flame, Award, TrendingUp, Lock, Star, Shield, Users, Crown, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-full animate-fade-in px-4 md:px-8 flex flex-col">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8 mt-8">
          ...
          {/* Main Player Card */}
          <div className="lg:col-span-2 bg-gradient-to-br from-gray-900 via-[#0a0a0b] to-black border border-gray-800 rounded-[32px] p-6 md:p-8 shadow-2xl relative overflow-hidden group">
              {/* Background Glow */}
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center gap-6 relative z-10">
                  ...
                  <div className="relative shrink-0">
                       ...
                       <div className="w-24 h-24 rounded-full bg-surface border-4 border-primary flex items-center justify-center relative shadow-xl">
                            <span className="text-3xl font-black text-white italic">{userStats.level}</span>
                            <div className="absolute -bottom-2 bg-black text-primary text-[10px] font-black uppercase px-2 py-0.5 rounded border border-primary">
                                Level
                            </div>
                       </div>
                  </div>
                  ...
                  <div className="flex-1 w-full">
                      <div className="flex items-center gap-3 mb-1">
                          <h2 className="text-2xl font-black text-white uppercase italic tracking-wider">{userStats.title}</h2>
                          {userStats.level > 10 && <CrownIcon size={20} className="text-yellow-400 fill-yellow-400" />}
                      </div>
                      ...
                      <div className="w-full h-4 bg-gray-800 rounded-full overflow-hidden border border-gray-700/50 shadow-inner">
                          <div 
                            className="h-full bg-gradient-to-r from-primary to-blue-500 relative transition-all duration-1000 ease-out"
               ...
               <div className="mt-6 border-t border-gray-800 pt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {userStats.challenges.slice(0, 2).map(challenge => (
                      <div key={challenge.id} className="bg-black/40 rounded-xl p-3 border border-gray-800 flex items-center gap-3">
                          <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary shrink-0">
                              <Target size={18} />
                          </div>
                          <div className="flex-1 min-w-0">
                              <h4 className="text-white text-xs font-bold truncate">{challenge.title}</h4>
      ...
      <div className="max-w-7xl mx-auto w-full mb-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 px-2 gap-4">
             ...
             <button onClick={() => setView(ViewState.ANALYZER)} className="text-primary font-bold hover:text-cyan-400 transition-colors flex items-center gap-2">
