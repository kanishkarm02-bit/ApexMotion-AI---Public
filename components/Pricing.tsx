  ...
  return (
    <div className="min-h-screen bg-background py-12 px-6 overflow-y-auto animate-fade-in">
        <div className="text-center max-w-3xl mx-auto mb-16 px-4">
            <h2 className="text-primary font-bold tracking-widest uppercase text-sm mb-4 break-words">Aim High. Rise Sky-High.</h2>
            <h1 className="text-4xl md:text-6xl font-black text-white mb-6">Unlock Elite Performance</h1>
