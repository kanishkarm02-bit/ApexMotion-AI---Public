  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-xl animate-in fade-in duration-300">
        ...
        <div className={`relative w-full max-w-md transform transition-all duration-700 ${showContent ? 'scale-100 opacity-100' : 'scale-90 opacity-0'}`}>
            ...
            {/* Glowing Card */}
            <div className="bg-[#0a0a0b] border-2 border-primary/50 rounded-[40px] p-8 shadow-[0_0_100px_rgba(6,182,212,0.3)] relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                    ...
                    <div className="mb-6 relative">
                        ...
                        <div className="relative w-32 h-32 bg-gradient-to-br from-gray-900 to-black border-4 border-primary rounded-full flex items-center justify-center shadow-2xl">
                             <Crown size={48} className="text-primary mb-1" />
                             <div className="absolute -bottom-4 bg-primary text-black font-black px-4 py-1 rounded-full text-lg shadow-lg border-2 border-white">
                                 LVL {newLevel}
                             </div>
                        </div>
                    </div>

                    <h2 className="text-4xl font-black text-white italic tracking-tighter mb-2 animate-bounce-slow">
                        LEVEL UP!
                    </h2>
                    
                    <div className="flex items-center gap-2 mb-8">
                        <span className="text-gray-400 font-bold uppercase tracking-widest text-xs">New Title Unlocked</span>
                    ...
                    <div className="grid grid-cols-2 gap-4 w-full mb-8">
                        <div className="bg-surface border border-gray-800 p-4 rounded-2xl flex flex-col items-center">
                            ...
                            <span className="text-2xl font-black text-white flex items-center gap-1">
                                +{xpGained} <Zap size={16} className="text-yellow-400 fill-yellow-400" />
                            </span>
                        </div>
                        <div className="bg-surface border border-gray-800 p-4 rounded-2xl flex flex-col items-center">
                            <span className="text-[10px] text-gray-500 font-black uppercase tracking-widest mb-1">Total Rank</span>
                            <span className="text-2xl font-black text-white">#{Math.max(1000 - newLevel * 10, 1)}</span>
                        </div>
                    </div>

                    <button 
                        onClick={handleClose}
                        className="w-full bg-white text-black font-black py-4 rounded-xl text-lg uppercase tracking-widest hover:bg-primary hover:scale-105 transition-all shadow-xl flex items-center justify-center gap-2 group"
                    >
